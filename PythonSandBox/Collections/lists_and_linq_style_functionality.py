...
# Filter - Linq.Where. Applies a predicate to an element.
print("\nFilter Is Even:")
...
# Reduce: loops through all elements, the input parameter is is the return value for the last element.
print("\nReduce")
print(functools.reduce(add, range(4)))          # Starting value of 0. 0 + 1 + 2 + 3
print(functools.reduce(add, range(4), 10))      # Starting value 10. 10 + 1 + 2 + 3