...
urlpatterns = \
    patterns('',
             ...
             url(r'^class/edit(?P<pk>[0-9]+)/$', views.class_form, name="form_class_edit"),
             url(r'^factory/create/$', views.model_form_factory_form, name="form_factory_create"),
             url(r'^factory/edit(?P<pk>[0-9]+)/$', views.model_form_factory_form, name="form_factory_edit"),
             url(r'^complete_model/create/$', views.complete_model_example, name="form_complete_create"),
             url(r'^complete_model/edit(?P<pk>[0-9]+)/$', views.complete_model_example, name="form_complete_edit")
             )
